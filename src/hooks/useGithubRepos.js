...
const FALLBACK = [
  ...
  { name: 'surqo', description: 'Plataforma IoT + IA que conecta sensores ESP32 con modelos de lenguaje para recomendaciones agronómicas.', homepage: 'https://www.surqo.online/', html_url: 'https://github.com/ricardomb-tech/surqo', stars: 0, languages: ['Python', 'TypeScript', 'C++'], updated: '' },
  ...
  { name: 'donde-oscar', description: 'App de localización en tiempo real para seguimiento de personas con IoT.', homepage: 'https://www.dondeoscar.site/', html_url: 'https://github.com/ricardomb-tech/donde-oscar', stars: 0, languages: ['TypeScript', 'CSS'], updated: '' },
